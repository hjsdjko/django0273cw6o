...
class dianyingleibie(BaseModel):
    __doc__ = u'''dianyingleibie'''
    __tablename__ = 'dianyingleibie'
    ...
    __isAdmin__='否'#表属性isAdmin=”是”,刷出来的用户表也是管理员，即page和list可以查看所有人的考试记录(同时应用于其他表)
    addtime = models.DateTimeField(auto_now_add=False, verbose_name=u'创建时间')
    dianyingleibie=models.CharField ( max_length=255, null=True,unique=True, verbose_name='电影类别' )
    image=models.TextField   (  null=True, unique=False, verbose_name='图片' )
    '''
    dianyingleibie=VARCHAR
    image=Text
    '''
    class Meta:
        db_table = 'dianyingleibie'
        verbose_name = verbose_name_plural = '电影类别'
class remendianying(BaseModel):
    __doc__ = u'''remendianying'''
    __tablename__ = 'remendianying'
    ...
    haibao=models.TextField   (  null=True, unique=False, verbose_name='海报' )
    dianyingleibie=models.CharField ( max_length=255, null=True, unique=False, verbose_name='电影类别' )
    ...
    dianyingshipin=models.TextField   (  null=True, unique=False, verbose_name='电影视频' )
    ...
    '''
    class Meta:
        db_table = 'remendianying'
        verbose_name = verbose_name_plural = '热门电影'
class dianyingxinxi(BaseModel):
    ...
    __isAdmin__='否'#表属性isAdmin=”是”,刷出来的用户表也是管理员，即page和list可以查看所有人的考试记录(同时应用于其他表)
    addtime = models.DateTimeField(auto_now_add=False, verbose_name=u'创建时间')
    title=models.CharField ( max_length=255, null=True, unique=False, verbose_name='名称' )
    picture=models.TextField   (  null=True, unique=False, verbose_name='图片' )
    tags=models.CharField ( max_length=255, null=True, unique=False, verbose_name='标签' )
    year=models.IntegerField  (  null=True, unique=False, verbose_name='年代' )
    pingfen=models.FloatField   (  null=True, unique=False, verbose_name='评分' )
    pjs=models.IntegerField  (  null=True, unique=False, verbose_name='评价数' )
    wxs=models.FloatField   (  null=True, unique=False, verbose_name='五星数' )
    uname=models.CharField ( max_length=255, null=True, unique=False, verbose_name='评论人' )
    ypxx=models.TextField   (  null=True, unique=False, verbose_name='影片信息' )
    plnr=models.TextField   (  null=True, unique=False, verbose_name='评论内容' )
    xqdz=models.CharField ( max_length=255, null=True, unique=False, verbose_name='详情地址' )
    thumbsupnum=models.IntegerField  (  null=True, unique=False,default='0', verbose_name='赞' )
    crazilynum=models.IntegerField  (  null=True, unique=False,default='0', verbose_name='踩' )
    discussnum=models.IntegerField  (  null=True, unique=False,default='0', verbose_name='评论数' )
    storeupnum=models.IntegerField  (  null=True, unique=False,default='0', verbose_name='收藏数' )
...
class discussremendianying(BaseModel):
    __doc__ = u'''discussremendianying'''
    __tablename__ = 'discussremendianying'
    ...
    '''
    class Meta:
        db_table = 'discussremendianying'
        verbose_name = verbose_name_plural = '热门电影评论表'
