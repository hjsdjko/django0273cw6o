...
def schemaName_spider(request, tableName):
    if request.method in ["POST", "GET"]:
        ...
        # Linux
        cmd = "cd /yykj/python/9999/spiderc2xklu0u && scrapy crawl "+tableName+"Spider -a databaseName=django0273cw6o"
        # Windows
        # cmd = "cd C:\\test1\\spider && scrapy crawl " + tableName + "Spider -a databaseName=django0273cw6o"
        os.system(cmd)
