			...
			<div :style='{"width":"25%","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts1">
					...
					<div :style='{"width":"100%","height":"calc(100% - 24px)"}'>
						<div id="remendianyingChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"width":"100%","alignItems":"flex-end","textAlign":"center","justifyContent":"center","display":"flex","height":"24px"}'>
					...
					<div :style='{"width":"100%","height":"calc(100% - 24px)"}'>
						<div id="remendianyingChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts3">
					<div :style='{"width":"100%","alignItems":"flex-end","textAlign":"center","justifyContent":"center","display":"flex","height":"24px"}'>
					...
					<div :style='{"width":"100%","height":"calc(100% - 24px)"}'>
						<div id="remendianyingChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
				...
				<div :style='{"alignContent":"center","padding":"20px 20px","margin":"0 0 20px 0","color":"#fff","alignItems":"center","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231125/26d4501d35db46278b1d99be2f14602f.png) no-repeat center top / 100% 100%","display":"flex","width":"calc(50% - 20px)","fontSize":"14px","height":"calc(40% - 20px)","order":"2"}'>
					...
					<div :style='{"width":"100%","alignItems":"center","background":"rgba(255,255,255,0)","justifyContent":"center","display":"flex"}'>
						...
						<div :style='{"padding":"0 20px","alignItems":"center","flex":"1","justifyContent":"space-between","display":"flex"}'>
							<div :style='{"lineHeight":"32px","fontSize":"inherit","color":"inherit","height":"32px"}'>热门电影总数</div>
							<div :style='{"lineHeight":"32px","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{remendianyingCount}}</div>
						</div>
					</div>
					...
					<div :style='{"width":"100%","alignItems":"center","background":"rgba(255,255,255,.1)","justifyContent":"center","display":"flex"}'>
						...
						<div :style='{"padding":"0 20px","alignItems":"center","flex":"1","justifyContent":"space-between","display":"flex"}'>
							<div :style='{"lineHeight":"32px","fontSize":"inherit","color":"inherit","height":"32px"}'>电影信息总数</div>
							<div :style='{"lineHeight":"32px","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{dianyingxinxiCount}}</div>
						</div>
					</div>
				</div>
				<div class="echarts4">
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="dianyingxinxiChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
			<div :style='{"width":"25%","flexWrap":"wrap","display":"flex"}'>
				<div class="tables">
					<div :style='{"margin":"0","color":"#fff","textAlign":"center","background":"rgba(255,255,255,0)","width":"100%","lineHeight":"40px","fontSize":"14px","height":"40px"}'>电影信息</div>
					<el-table :data="boardDataList" border :stripe="false" :style='{"width":"100%","padding":"0","borderColor":"#5c89e6","borderStyle":"solid","borderWidth":"1px 0 0 1px","background":"none"}'>
						...
						<el-table-column :resizable="true" :sortable="false" prop="tags" label="标签"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="year" label="年代"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="pingfen" label="评分"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="pjs" label="评价数"/>
						</el-table-column>
					</el-table>
				</div>
				<div class="echarts5">
					...
					<div :style='{"width":"100%","height":"calc(100% - 30px)"}'>
						<div id="dianyingxinxiChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
...
//统计接口1
    dianyingxinxiChat4() {
      this.$nextTick(()=>{
        ...
        var dianyingxinxiChart4 = echarts.init(document.getElementById("dianyingxinxiChart4"),'caravan');
        this.$http({
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                var option = {};
                this.wordclouds(pArray,'dianyingxinxiChart5');
