...
<div class="center-preview" :style='{"width":"100%","padding":"0","margin":"10px auto","position":"relative","background":"none"}'>
	...
	<div class="info" :style='{"padding":"30px 70px","boxShadow":"none","margin":"0 auto 20px","alignItems":"center","display":"flex","justifyContent":"center","borderRadius":"10px","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20240113/af5db0ea80244cc3a4cb58b8083aa02f.png)","width":"80%","backgroundSize":"100% 100%","backgroundPosition":"center center","backgroundRepeat":"no-repeat","height":"auto"}'>
		...
		<div :style='{"padding":"0 20px","borderColor":"#efefef","margin":"20px 0 0","alignItems":"center","borderWidth":"0","flexDirection":"column","display":"flex","width":"auto","lineHeight":"30px","borderStyle":"solid","justifyContent":"center","height":"auto"}' v-if="userTableName=='yonghu'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
			<div :style='{"color":"#FFC174","fontSize":"14px"}'>用户账号</div>
			<div :style='{"fontSize":"16px","color":"#FFC174","textAlign":"left","flex":1,"fontWeight":"bold"}'>{{sessionForm.yonghuzhanghao}}</div>
		</div>
		<div :style='{"padding":"0 20px","borderColor":"#efefef","margin":"20px 0 0","alignItems":"center","flexDirection":"column","display":"flex","justifyContent":"center","borderRadius":"5px","borderWidth":"0","background":"none","width":"auto","lineHeight":"30px","borderStyle":"solid","height":"auto"}' v-if="userTableName=='yonghu'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
			<div :style='{"color":"#FFC174","fontSize":"14px"}'>用户姓名</div>
			<div :style='{"fontSize":"14px","color":"#FFC174","textAlign":"center","flex":1}'>{{sessionForm.yonghuxingming}}</div>
		</div>
		<div :style='{"padding":"0 20px","borderColor":"#efefef","margin":"20px 0 0","alignItems":"center","borderWidth":"0","flexDirection":"column","display":"flex","width":"auto","lineHeight":"30px","borderStyle":"solid","justifyContent":"center","height":"auto"}' v-if="userTableName=='yonghu'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
		...
		<div :style='{"padding":"0 20px","borderColor":"#efefef","margin":"20px 0 0","alignItems":"center","borderWidth":"0","flexDirection":"column","display":"flex","width":"auto","lineHeight":"30px","borderStyle":"solid","justifyContent":"center","height":"auto"}' v-if="userTableName=='yonghu'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
			<div :style='{"color":"#FFC174","fontSize":"14px"}'>联系方式</div>
			<div :style='{"fontSize":"14px","color":"#FFC174","textAlign":"center","flex":1}'>{{sessionForm.lianxifangshi}}</div>
		</div>
		<div :style='{"padding":"0 20px","borderColor":"#efefef","margin":"20px 0 0","alignItems":"center","borderWidth":"0","flexDirection":"column","display":"flex","width":"auto","lineHeight":"30px","borderStyle":"solid","justifyContent":"center","height":"auto"}' v-if="userTableName=='yonghu'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
			<div :style='{"color":"#FFC174","fontSize":"14px"}'>状态</div>
			<div :style='{"color":"#FFC174","textAlign":"center","fontSize":"14px"}'>{{sessionForm.status}}</div>
		</div>
		<div :style='{"padding":"0 20px","borderColor":"#efefef","margin":"20px 0 0","alignItems":"center","borderWidth":"0","flexDirection":"column","display":"flex","width":"auto","lineHeight":"30px","borderStyle":"solid","justifyContent":"center","height":"auto"}' v-if="userTableName=='yonghu'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
			<div :style='{"color":"#FFC174","fontSize":"14px"}'>密码错误次数</div>
			<div :style='{"fontSize":"14px","color":"#FFC174","textAlign":"center","flex":1}'>{{sessionForm.passwordwrongnum}}</div>
		</div>
